<template>
  <div class="alunos container">
    ...
    <hr />
    <TabelaAluno :listaAlunos="alunos" @excluirAluno='excluirAluno'/> <!-- O que é passado no emit-->
...
<script>
import TabelaAluno from './TabelaAluno.vue' 
...
export default {
    ...
    components: {
            TabelaAluno // como se fosse export default
    },
    methods:{
        adicionarAluno() {
            if (this.aluno.nome) {
